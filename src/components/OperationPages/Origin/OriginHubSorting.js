...
function OriginHubSorting() {
  return (
    <div>
<SideBar/>
<main className='pt-5'>
 <div className='container-fluid pt-4' id='origin'>
 <p>Operations / Origin hub / Sorting / ABV</p>
    <h5>Origin Hub</h5>
    <h6 className=''>Sorting</h6>
    <div class="d-flex justify-content-between fs-12 mb-3">
    <div class="p-2 bd-highlight">
       <Link to='/origin-hub-sorting' class="btn btn-primary bg-1 btn-1 fs-12 px-3 mx-2 " type="submit">ABV</Link> 
       </div>
       <div class="p-2 bd-highlight " id='origin'>
        <Link to='/origin-hub-sorting-mld' className='text-muted text-decoration-none'>MLD</Link>
       </div>
       <div class="p-2 bd-highlight" id='origin'>
       <Link to='/origin-hub-sorting-bkk' className=' text-muted text-decoration-none'>BKK</Link>
       </div>
       <div class="p-2 bd-highlight" id='origin'>
       <Link to='/origin-hub-sorting-ekt' className='text-muted text-decoration-none'>EKT</Link>
       </div>
...
export default OriginHubSorting