...
function OriginHubSortingMld() {
  return (
    <div>
    <SideBar/>
    <main className='pt-5'>
     <div className='container-fluid pt-4' id='origin'>
     <p>Operations / Origin hub / Sorting / MLD</p>
        <h5>Origin Hub</h5>
       ...
       <Link to='/origin-hub-sorting' className=' text-muted text-decoration-none'>ABV</Link>
        ...
        <div class="p-2 bd-highlight" id='origin'>
           <Link to='/origin-hub-sorting-mld' class="btn btn-primary bg-1 btn-1 fs-12 px-3 mx-2 " type="submit">MLD</Link> 
           </div>
           <div class="p-2 bd-highlight" id='origin'>
           <Link to='/origin-hub-sorting-bkk' className='text-decoration-none text-muted'>BKK</Link>
           </div>
           <div class=" p-2 bd-highlight" id='origin'>
...
export default OriginHubSortingMld