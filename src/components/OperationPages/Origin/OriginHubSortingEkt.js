...
function OriginHubSortingEkt() {
  return (
    <div>
    <SideBar/>
    <main className='pt-5'>
     <div className='container-fluid pt-4' id='origin'>
     <p>Operations / Origin hub / Sorting / EKT</p>
        <h5>Origin Hub</h5>
       ...
       <Link to='/origin-hub-sorting-bkk' className=' text-muted text-decoration-none'>BKK</Link>
        ...
        <div class="p-2 bd-highlight" id='origin'>
           <Link to='/origin-hub-sorting-ekt' class="btn btn-primary bg-1 btn-1 fs-12 px-3 mx-2 " type="submit">EKT</Link> 
           </div>
...
export default OriginHubSortingEkt