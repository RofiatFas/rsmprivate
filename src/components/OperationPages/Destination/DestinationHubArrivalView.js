...
function DestinationHubArrivalView() {
  return (
    <div>
    <SideBar/>
    <main className='pt-5'>
        <div className='container-fluid pt-4' id='destinatiion'>
        <p>Operations / Destination hub / Arrival</p>
           <h6>Verifying Pack Bag #00245631</h6>
           <div className='d-flex mb-3'>
            <p>26 Items</p>
            <button class="btn btn-primary btn-1 fs-12 px-3 mx-2 ms-auto" type="submit">Save</button> 
           </div>
        </div>
...
export default DestinationHubArrivalView