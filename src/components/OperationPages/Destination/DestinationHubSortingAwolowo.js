...
function DestinationHubSortingAwolowo() {
  return (
    <div>
    <div>
<SideBar/>
<main className='pt-5'>
 ...
 <p>Operations / Destination hub / Sorting / Awolowo</p>
    ...
    <div class="p-2 bd-highlight" id='destination'>
       ...
       <Link to='/destination-hub-sorting-awolowo' class="btn btn-primary bg-1 btn-1 fs-12 px-3 mx-2 text-decoration-none">Awolowo</Link> 
       </div>
...
export default DestinationHubSortingAwolowo