...
function DestinationHubWeighing() {
  return (
    <div>
    <SideBar/>
    <main className='pt-5'>
        <div className='container-fluid pt-4' id='destination'>
        <p>Operations / Destination hub / Weighing</p>
...
<tr className=''>
  ...
  <td className=' text-success'><div className=''><span type="button" class="fs-13 verified-btn bg-2 text-success border-0 rounded-pill p-1"><span className='dot mx-2'></span>Completed</span>
    ...
    <td className='fw-bold' id='destination'>
      <Link to='/destination-hub-weighing-view' className='text-decoration-none text-success'>View</Link>
    </td>
</tr>
<tr className=''>
  <td scope="row">#00245631</td>
...
export default DestinationHubWeighing